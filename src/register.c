...
////{
////	if(type == 1)//write
////		write_Data_SubMemory(data,addr);
////	else//read
////		read_Data_SubMemory(addr);
////}
//
...
//	{
//		writeDirectMemory(data, 0x40+i);
//	}
////	writeDirectMemory(data, 0x40);
////	writeDirectMemory(crc8, 0x60);
////	writeDirectMemory(data_length, 0x61);
//	
//}
//
